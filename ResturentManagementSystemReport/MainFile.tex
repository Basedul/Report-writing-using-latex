...
\par\vspace{3cm}
	...
	\hline
	\huge \textbf{Name} & \textbf{HOSSAIN SYED ABIR(\zh{阿贝尔})} &\\[25pt]
	\hline
	\huge\textbf{Major} & \textbf{Computer Science and Technology}&\\[25pt]
	\hline
	\huge\textbf{Supervisor} & \textbf{Prof. Liang Zhao}&\\[25pt]
	\hline
	\end{tabular}
	\end{table}	
	...
	\vspace{2.5cm}
	{\scshape\huge Shenyang Aerospace University \par}
	\vspace{1.5cm}
...
\begin{titlepage}
	\center {\huge\bfseries Asian Restaurant Management System\par}
	\vspace{2cm}
